...
import { InstagramBlue, Warning } from '@/src/components/icons'
...
const PostNode = ({ id }: Props) => {
  ...
  return (
   ...
   data.data.posts.length > 0 && (
    <div className='w-10/12 lg:w-8/12 relative xl:w-4/12 p-5 
    rounded-xl flex flex-col bg-[#1D1D1D] gap-y-3'>
